...
(function () {
  ...
  function asistente(q) {
    ...
    return `Puedo responder con los números del sistema: qué zona rinde más, la mejor temporada, de dónde vienen los viajes, choferes, camionetas, clientes, aliados y comisiones, no-shows, flota, pagos pendientes, margen y el día de hoy. Pruebe, por ejemplo: «¿qué zona rinde más?» o «¿qué hay pendiente de cobrar?».`;
  }
